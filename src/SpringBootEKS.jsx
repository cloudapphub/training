...
import { springbootLessons as lessons } from "./springbootLessons";
...
export default function SpringBootEKS() {
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16">
        ...
        <header className="mb-6">
          <div className="flex items-center gap-2 text-yellow-400 mb-2">
            <BookOpen size={22} />
            <h1 className="text-2xl sm:text-3xl font-bold">Spring Boot on EKS with Aurora PostgreSQL</h1>
          </div>
          <p className="text-slate-400 text-sm">
            8 focused hours. Connect Spring Boot to Aurora on EKS — from architecture to credential rotation to production monitoring.
          </p>
          ...
          {lesson.code && (
            <section className="mb-5">
              <div className="flex items-center gap-2 text-green-400 text-sm font-semibold mb-2">
                <Code2 size={16} /> {lesson.infraCode ? "Application Code" : "Sample Code"}
              </div>
          ...
          {lesson.infraCode && (
            <section className="mb-5">
              <div className="flex items-center gap-2 text-cyan-400 text-sm font-semibold mb-2">
                <Code2 size={16} /> AWS Cloud Infrastructure Code
              </div>
              <pre className="bg-black/60 border border-slate-800 rounded-lg p-4 overflow-x-auto text-xs sm:text-sm font-mono text-slate-200 whitespace-pre">
                {lesson.infraCode}
              </pre>
