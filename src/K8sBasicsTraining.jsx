...
import { ChevronLeft, ChevronRight, BookOpen, Code2, CheckCircle2, Clock, Lightbulb, ArrowLeft, Layers } from "lucide-react";
import { k8sBasicsLessons as lessons } from "./k8sBasicsLessons";
...
export default function K8sBasicsTraining() {
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16">
        ...
        <header className="mb-6">
          <div className="flex items-center gap-2 text-cyan-400 mb-2">
            <Layers size={22} />
            <h1 className="text-2xl sm:text-3xl font-bold">Kubernetes Basics — First Timer's Guide</h1>
          </div>
          <p className="text-slate-400 text-sm">
            8 hands-on lessons. Learn Pods, Deployments, Services, ConfigMaps, Namespaces, Resource Management, and Health Checks — from zero to confident.
          </p>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 sm:p-7 shadow-xl">
          <div className="flex items-center gap-2 text-xs text-cyan-500 uppercase tracking-wider mb-2">
