...
import { genaiLessons as lessons } from "./genaiLessons";
...
export default function GenAILLM() {
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16">
        ...
        <header className="mb-6">
          <div className="flex items-center gap-2 text-yellow-400 mb-2">
            <BookOpen size={22} />
            <h1 className="text-2xl sm:text-3xl font-bold">Generative AI & LLM Concepts — Mid-Level</h1>
          </div>
          <p className="text-slate-400 text-sm">
            8 focused hours. From transformers to production — embeddings, RAG, function calling, agents, and evaluation with real Python code.
          </p>
